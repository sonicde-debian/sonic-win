...
KWin provides a unit and integration test suite for X11. The source code for the tests can be found in the subdirectory autotests. The test suite should be run prior to any merge to KWin.
